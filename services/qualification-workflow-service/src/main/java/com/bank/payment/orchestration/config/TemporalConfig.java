...
import com.bank.payment.orchestration.workflow.impl.QualificationWorkflowImpl;
 ...
 * task queue (TaskQueues.QUALIFICATION) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        Worker worker = factory.newWorker(TaskQueues.QUALIFICATION);
        worker.registerWorkflowImplementationTypes(QualificationWorkflowImpl.class);
