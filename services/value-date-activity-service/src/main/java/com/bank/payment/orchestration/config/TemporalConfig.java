...
import com.bank.payment.orchestration.activities.ValueDateActivitiesImpl;
 ...
 * task queue (TaskQueues.VALUE_DATE_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            ValueDateActivitiesImpl valueDateActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.VALUE_DATE_ACTIVITY);
        
        worker.registerActivitiesImplementations(valueDateActivitiesImpl);
        return factory;
    }
