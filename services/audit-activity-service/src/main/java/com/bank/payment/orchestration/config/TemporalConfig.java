...
import com.bank.payment.orchestration.activities.AuditActivitiesImpl;
 ...
 * task queue (TaskQueues.AUDIT_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            AuditActivitiesImpl auditActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.AUDIT_ACTIVITY);
        
        worker.registerActivitiesImplementations(auditActivitiesImpl);
        return factory;
    }
