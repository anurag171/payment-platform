...
import com.bank.payment.orchestration.activities.PartnerActivitiesImpl;
 ...
 * task queue (TaskQueues.PARTNER_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            PartnerActivitiesImpl partnerActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.PARTNER_ACTIVITY);
        
        worker.registerActivitiesImplementations(partnerActivitiesImpl);
        return factory;
    }
