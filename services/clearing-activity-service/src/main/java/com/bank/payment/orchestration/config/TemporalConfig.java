...
import com.bank.payment.orchestration.activities.ClearingActivitiesImpl;
 ...
 * task queue (TaskQueues.CLEARING_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            ClearingActivitiesImpl clearingActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.CLEARING_ACTIVITY);
        
        worker.registerActivitiesImplementations(clearingActivitiesImpl);
        return factory;
    }
