...
import com.bank.payment.orchestration.activities.MopActivitiesImpl;
 ...
 * task queue (TaskQueues.MOP_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            MopActivitiesImpl mopActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.MOP_ACTIVITY);
        
        worker.registerActivitiesImplementations(mopActivitiesImpl);
        return factory;
    }
