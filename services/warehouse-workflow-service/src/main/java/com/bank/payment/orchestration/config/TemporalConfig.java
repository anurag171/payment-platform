...
import com.bank.payment.orchestration.workflow.impl.WarehouseWorkflowImpl;
 ...
 * task queue (TaskQueues.WAREHOUSE) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        Worker worker = factory.newWorker(TaskQueues.WAREHOUSE);
        worker.registerWorkflowImplementationTypes(WarehouseWorkflowImpl.class);
