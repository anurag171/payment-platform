...
import com.bank.payment.orchestration.workflow.impl.MopDerivationWorkflowImpl;
 ...
 * task queue (TaskQueues.MOP_DERIVATION) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        Worker worker = factory.newWorker(TaskQueues.MOP_DERIVATION);
        worker.registerWorkflowImplementationTypes(MopDerivationWorkflowImpl.class);
