...
import com.bank.payment.orchestration.activities.EnrichmentActivitiesImpl;
 ...
 * task queue (TaskQueues.ENRICHMENT_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            EnrichmentActivitiesImpl enrichmentActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.ENRICHMENT_ACTIVITY);
        
        worker.registerActivitiesImplementations(enrichmentActivitiesImpl);
        return factory;
    }
