...
import com.bank.payment.orchestration.activities.TranslationActivitiesImpl;
 ...
 * task queue (TaskQueues.TRANSLATION_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            TranslationActivitiesImpl translationActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.TRANSLATION_ACTIVITY);
        
        worker.registerActivitiesImplementations(translationActivitiesImpl);
        return factory;
    }
