...
import com.bank.payment.orchestration.workflow.impl.PaymentProcessingWorkflowImpl;
 ...
 * task queue (TaskQueues.PAYMENT_PROCESSING) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        Worker worker = factory.newWorker(TaskQueues.PAYMENT_PROCESSING);
