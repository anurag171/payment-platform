...
import com.bank.payment.orchestration.activities.ReversalActivitiesImpl;
 ...
 * task queue (TaskQueues.REVERSAL_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            ReversalActivitiesImpl reversalActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.REVERSAL_ACTIVITY);
        
        worker.registerActivitiesImplementations(reversalActivitiesImpl);
        return factory;
    }
