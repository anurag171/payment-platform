...
import com.bank.payment.orchestration.workflow.impl.InboundNormalizationWorkflowImpl;
 ...
 * task queue (TaskQueues.INBOUND_NORMALIZATION) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        Worker worker = factory.newWorker(TaskQueues.INBOUND_NORMALIZATION);
        worker.registerWorkflowImplementationTypes(InboundNormalizationWorkflowImpl.class);
