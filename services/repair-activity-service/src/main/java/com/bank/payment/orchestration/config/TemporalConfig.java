...
import com.bank.payment.orchestration.activities.RepairActivitiesImpl;
 ...
 * task queue (TaskQueues.REPAIR_ACTIVITY) — the whole point of the decomposition. Every
...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient client,
            RepairActivitiesImpl repairActivitiesImpl) {
        WorkerFactory factory = WorkerFactory.newInstance(client);
        Worker worker = factory.newWorker(TaskQueues.REPAIR_ACTIVITY);
        
        worker.registerActivitiesImplementations(repairActivitiesImpl);
        return factory;
    }
